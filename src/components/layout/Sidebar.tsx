...
const getNavigation = (t: (key: string) => string): NavItem[] => [
    ...
    { label: t('sidebar.marketing'), icon: <Megaphone size={20} />, module: 'marketing', children: [{ label: t('sidebar.ads'), href: '/marketing/ads' }, { label: t('sidebar.pushNotifications'), href: '/marketing/push-notifications' }, { label: t('sidebar.promoCodes'), href: '/marketing/promo-codes' }, { label: t('sidebar.campaigns'), href: '/marketing/campaigns' }, { label: t('sidebar.featured'), href: '/marketing/featured' }, { label: t('sidebar.banners'), href: '/marketing/banners' }] },
    { label: t('sidebar.support'), icon: <Headphones size={20} />, href: '/support', module: 'support' },
    { label: t('sidebar.content'), icon: <FileText size={20} />, module: 'content', children: [{ label: t('sidebar.pages'), href: '/content/pages' }, { label: t('sidebar.templates'), href: '/content/templates' }, { label: t('sidebar.announcements'), href: '/content/announcements' }, { label: t('sidebar.categories'), href: '/content/categories' }] },
    { label: t('sidebar.settings'), icon: <Settings size={20} />, module: 'settings', children: [{ label: t('sidebar.platform'), href: '/settings/platform' }, { label: t('sidebar.countries'), href: '/settings/countries' }, { label: t('sidebar.payments'), href: '/settings/payments' }, { label: t('sidebar.roles'), href: '/settings/roles' }, { label: t('sidebar.admins'), href: '/settings/admins' }, { label: t('sidebar.appearance'), href: '/settings/appearance' }, { label: t('sidebar.localizationSettings'), href: '/settings/localization' }, { label: t('sidebar.security'), href: '/settings/security' }] },
    { label: t('sidebar.appVersions'), icon: <Smartphone size={20} />, href: '/app-versions', module: 'app_versions' },
    { label: t('sidebar.systemHealth'), icon: <Activity size={20} />, href: '/system-health', module: 'system_health' },
    { label: t('sidebar.auditLogs'), icon: <ScrollText size={20} />, href: '/audit-logs', module: 'audit_logs' },
    { label: t('sidebar.localization'), icon: <Globe size={20} />, href: '/localization', module: 'localization' },
];
