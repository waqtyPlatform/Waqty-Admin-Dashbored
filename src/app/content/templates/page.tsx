...
const initialTemplates: EmailTemplate[] = [
    { id: '1', name: 'Welcome Email', slug: 'welcome', subject: 'Welcome to Waqty!', subject_ar: 'مرحباً في وقتي!', body_html: '<h1>Welcome {{name}}!</h1><p>Your account is ready.</p>', body_html_ar: '<h1>مرحباً {{name}}!</h1><p>حسابك جاهز.</p>', variables: ['name', 'email'], type: 'email', active: true, created_at: '2023-01-01T00:00:00Z', updated_at: '2026-04-01T10:00:00Z' },
